        ...
        <div className="HomeGreetings__content">
          <div className="HomeGreetings__pastor">
            <div className="HomeGreetings__pastor__image">
              <img src={pastorPhoto} alt="Pr. Joseph K Joseph" draggable="false" />
            </div>
            <div className="HomeGreetings__pastor__info">
              <div className="HomeGreetings__pastor__info__name">Pr. Biju Cherian</div>
              <div className="HomeGreetings__pastor__info__role">Senior Pastor</div>
            </div>
          </div>
